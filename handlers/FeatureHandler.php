...
/**
 * Feature content handler
 * Handles feature-specific structure and validation
 */
class FeatureHandler extends BaseContentHandler {
  ...
  /**
   * Get default structure for new feature
   */
  ...
  /**
   * Process optional metadata fields for features
   */
