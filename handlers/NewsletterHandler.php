...
/**
 * Newsletter content handler
 * Handles newsletter-specific processing
 */
class NewsletterHandler extends BaseContentHandler {
  ...
  /**
   * Process optional metadata fields for newsletters
   */
